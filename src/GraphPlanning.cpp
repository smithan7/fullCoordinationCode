...
void GraphPlanning::marketPoses( Costmap &costmap, Point cLoc, Point &gLoc ){
	...
	cerr << "GraphPlanning::marketPoses::C" << endl;
	...
	cerr << "GraphPlanning::marketPoses::D" << endl;
	...
	while( true ){ // find best pose
		...
		cerr << "GraphPlanning::marketPoses::poseValue[maxPose]: " << poseValue[maxPose] << endl;
		...
		cerr << "GraphPlanning::marketPoses::D5" << endl;


		//cout << "maxPose: index, value, rewards, distance: " << maxPose << ", " << poseValue[maxPose] << ", " << poseRewards[maxPose] << ", " << poseDistances[maxPose] << endl;
	}

	cerr << "GraphPlanning::marketPoses::gValue: " << poseValue[maxPose] << endl;
	cerr << "GraphPlanning::marketPoses::goalPose: " << poseGraph.nodeLocations[maxPose] << endl;

	gLoc = poseGraph.nodeLocations[maxPose];

	cerr << "GraphPlanning::marketPoses::Z" << endl;
}
